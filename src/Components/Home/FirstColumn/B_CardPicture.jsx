import imgPerfil from '../../../Multimedia/Images/imgPerfil.png'
  ...
  return (
    <div className='bg-secondary m-auto ' style={{width:'93%'}}>
      <div className="card m-auto bg-secondary border-0  p-0" style={{width:'70%'}}>
          <img src={imgPerfil} className="rounded-circle m-auto mt-3" alt="..." style={{width:'40%', objectFit:'cover', objectPosition:'center'}} />
